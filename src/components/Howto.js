...
class HowTo extends Component {
  ...
  render() {
    ...
    let steps = [
      "Download Metamask. You must be logged in MetaMask to navigate through ChainSongs offerings and purchase songs and royalties",
      "Explore ChainSongs Offers.",
      ...
      "We highly recommend our users to only use one ethereum account per profile with ChainSongs.",
    ];
    const metamask = "src/";
    return (
      <div className={classes.root}>
        <Grid container spacing={24} className={classes.grid}>
          ...
          >
            How To Get Started with ChainSongs
          </Typography>
          <Grid item xs={6}>
            <Typography
              variant="h4"
            ...
            <Typography
              ...
              style={{ marginBottom: 20, color: "white" }}
            >
              You must be logged in MetaMask to navigate through ChainSongs
              offerings and purchase songs and royalties
            </Typography>
          </Grid>
          <Grid item xs={6}>
          ...
          <Grid item xs={12}>
            <Typography variant="h4" align="left" style={{ color: "#788CFF" }}>
              Step 2
            </Typography>
            <Typography
              className={this.props.classes.desc}
