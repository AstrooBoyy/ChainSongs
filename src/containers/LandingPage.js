          ...
          <div className={classes.infoSection}>
            <div className={classes.infoSubSection}>
              ...
              <Typography variant="p" className={classes.description}>
                Buy songs that you love directly from artists. Listen to them
                whenever you want.
              </Typography>
            </div>
            <br></br>
            ...
            <div className={classes.infoSubSection}>
              ...
              <br></br>
              <Typography variant="p" className={classes.description}>
                Upload your songs and directly sell them to your fans. Split
                payments between owners without the need of intermediaries.
              </Typography>
            </div>
          </div>
          <div className={classes.infoSection}>
        ...
        <div className={classes.infoSectionContainer2}>
          ...
          <div className={classes.infoSection}>
            <div className={classes.infoSubSection}>
              ...
              <br></br>
              <Typography variant="p" className={classes.description}>
                Buy and sell phonogram royalties of your favorite songs.
                Pre-register owners and get funded for your music
              </Typography>
            </div>
          </div>
        </div>
        <div className={classes.footerContainer}>
          <div className={classes.footerSection}>
            <ul
              ...
              style={{ "list-style-type": "none", textAlign: "start" }}
            >
              <a href="">
                <li>
                  <Typography variant="p" className={classes.description}>
